...
public class CustomizedErrorHandler extends ResponseEntityExceptionHandler{
	...
	public final ResponseEntity<Todo> handleAllException(Exception ex, WebRequest request) throws Exception {
		TodoErrorResponse errorResponse = new TodoErrorResponse(new Date(), ex.getMessage(), request.getDescription(false));
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		TodoErrorResponse errorResponse = new TodoErrorResponse(new Date(), "Validation Failed", ex.getBindingResult().toString());
